...
export FNCM_NAMESPACE="/cp/cp4a/fncm/cpe"
...
export FNCM_ADD_CLUSTER_USER="No"
export FNCM_CLUSTER_USER=""

# FNCM_ENTITLEMENT_KEY: Choose either entitlement key or local registry
# Set for entitlement registry
export FNCM_ENTITLEMENT_KEY="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJJQk0gTWFya2V0cGxhY2UiLCJpYXQiOjE3MTcxOTIzMTksImp0aSI6IjRkOTk0NjVhM2QzNDQwYjlhNjhlNzJmZThjNzkyZTY5In0.FksiEfQIgbKRR9tG3ssL0_NCH7y_EIvwWSMeyEUmqw8"
